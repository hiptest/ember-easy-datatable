...
const customHelpers = (function () {
  ...
  registerAsyncHelper('clickOnMoveLeftColumn', function (app, columnIndex) {
    let context =
      fmt('thead tr:first-child td:nth-child(%@)', columnIndex + 1) +
      ', ' +
      fmt('thead tr:first-child th:nth-child(%@)', columnIndex + 1)
  ...
  registerAsyncHelper('clickOnPencil', function (app, row, column) {
    let context =
      fmt('thead tr:nth-child(%@) td:nth-child(%@)', row, column + 1) +
      ', ' +
      fmt('thead tr:nth-child(%@) th:nth-child(%@)', row, column + 1)
  ...
  function getHighlightedCellsText() {
    return find('td.highlighted, th.highlighted')
      .map(function () {
